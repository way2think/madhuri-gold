          ...
          <div className={`${classes.carouselWrap} row`}>
            ...
            <div className="col-md-8">
              ...
              >
                ...
                <button
                  ...
                  onClick={() =>
                    navigate.push('/collections?metal=diamond&sort=latest')
                  }
                >
                  Shop Now
                </button>
            ...
            <div className="col-md-4">
              <div className={`${classes.overallimage} relative w-full h-full`}>
                <Image
                  src="/assets/images/model-closeup/slider1.png" // Ensure this image is in public/
        ...
        <SwiperSlide>
          <div className={`${classes.carouselWrap} row`}>
            ...
            <div className="col-md-8">
              ...
              >
                <h4 className={`${classes.latest}`}>LATEST ADDITIONS</h4>
                <h2 className={classes.Bannerheading2}>Gold jewellery</h2>{' '}
                <p className={classes.glow}>
                  Glow forever in style with our exquisite new designs
                </p>
                <button
                  className={classes.shop}
                  onClick={() =>
                    navigate.push('/collections?metal=gold&sort=latest')
                  }
                >
                  Shop Now
                </button>
            ...
            <div className="col-md-4">
              <div className={`${classes.overallimage} relative w-full h-full`}>
                <Image
                  src="/assets/images/model-closeup/slider2.png" // Ensure this image is in public/
        ...
        <SwiperSlide>
          <div className={`${classes.carouselWrap} row`}>
            ...
            <div className="col-md-8">
              ...
              >
                ...
                <button
                  className={classes.shop}
                  onClick={() =>
                    navigate.push('/collections?metal=silver&sort=latest')
                  }
                >
                  Shop Now
                </button>
            ...
            <div className="col-md-4">
              <div className={`${classes.overallimage} relative w-full h-full`}>
                <Image
                  src="/assets/images/model-closeup/slider3.png" // Ensure this image is in public/
